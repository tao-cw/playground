      ...
      000003 02 00 74         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;t                         Allocated to registers 
                                    310 ;------------------------------------------------------------
                                    311 ;	led.c:3: static void delay(unsigned int t) {
                                    312 ;	-----------------------------------------
                                    313 ;	 function delay
                                    314 ;	-----------------------------------------
      000062                        315 _delay:
                           ...
                           000001   322 	ar1 = 0x01
                           000000   323 	ar0 = 0x00
      000062 AE 82            [24]  324 	mov	r6,dpl
      000064 AF 83            [24]  325 	mov	r7,dph
                                    326 ;	led.c:4: while (t--);
      000066                        327 00101$:
      000066 8E 04            [24]  328 	mov	ar4,r6
      000068 8F 05            [24]  329 	mov	ar5,r7
      00006A 1E               [12]  330 	dec	r6
      00006B BE FF 01         [24]  331 	cjne	r6,#0xff,00111$
      00006E 1F               [12]  332 	dec	r7
      00006F                        333 00111$:
      00006F EC               [12]  334 	mov	a,r4
      000070 4D               [12]  335 	orl	a,r5
      000071 70 F3            [24]  336 	jnz	00101$
                                    337 ;	led.c:5: }
      000073 22               [24]  338 	ret
                                    339 ;------------------------------------------------------------
                                    340 ;Allocation info for local variables in function 'main'
                                    341 ;------------------------------------------------------------
                                    342 ;	led.c:7: void main(void) {
                                    343 ;	-----------------------------------------
                                    344 ;	 function main
                                    345 ;	-----------------------------------------
      000074                        346 _main:
